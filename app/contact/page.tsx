      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="grid md:grid-cols-2 gap-16">
            {/* Contact Information */}
            <div>
              <h2 className="text-4xl font-bold mb-8 text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>Contact Information</h2>
              ...
              <div className="space-y-8">
                <div className="flex gap-4">
                  <div className="flex-shrink-0">
                    <div className="flex items-center justify-center h-12 w-12 rounded-lg bg-[#00CED1]/10">
                      <span className="text-2xl">📧</span>
                    </div>
                  </div>
                  <div>
                    <h3 className="font-bold text-lg mb-2 text-gray-900">Email</h3>
                    <p className="text-gray-700">info@zelitsolutions.com</p>
                    <p className="text-gray-700">sales@zelitsolutions.com</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">+254 714 635554</p>
            ...
            <div className="bg-gray-50 border border-gray-200 p-10 rounded-lg">
              <h2 className="text-3xl font-bold mb-8 text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>Send us a Message</h2>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#00CED1] focus:border-transparent transition"
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-[#00CED1] hover:bg-cyan-500 text-white py-3 rounded-lg font-bold transition text-lg"
                >
                  Send Message
                </button>
              </form>
